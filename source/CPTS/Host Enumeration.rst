...
Once connected in the rpcclient shell, use help to see all the available commands that can be run. 
...
Example 7: Using using :doc:`dnsenum <../tools/dnsenum>`
...
Example 7: using :doc:`dnsrecon <../tools/dnsrecon>`
...
Example 8: Using :doc:`dnsX <../tools/dnsx>`
...
Example 9: using :doc:`subfinder <../tools/subfinder>`
